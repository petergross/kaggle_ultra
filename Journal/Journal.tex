...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Deep Learning Algorithm Applied to Kaggle Ultrasound Nerve Segmentation},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Deep Learning Algorithm Applied to Kaggle Ultrasound Nerve Segmentation}
    \author[Aculocity, LLC]{Peter Gross\corref{c1}}
   \ead{pgross@aculocity.com} 
   \cortext[c1]{Corresponding Author}
    \author[Aculocity, LLC]{Warren Allworth}
   \ead{wallworth@aculocity.com} 
  
      \address[Aculocity]{Data Department, Oxford Street, Durbanville, Western Cape, 7530}
  
  \begin{abstract}
  This paper journals the approach taken to apply Deep Learning neural
  networks to the domain of identifying nerve endings found in ultrasound
  scanned images.
  
  The images were provided through the Kaggle website and was part of a
  competition closing 18 August 2016 with a prize money of \$100 000.
  \end{abstract}
...
Reference is made to (Trevor Hastie 2008).
...
\hypertarget{ref-ESLII}{}
Trevor Hastie, Jerome Friedman, Robert Tibshirani. 2008. \emph{Elements
of Statistical Learning, 2nd Edition}. Springer.
